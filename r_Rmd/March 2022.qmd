...
# 20220310: Unlocked Challenge #2 - Natural Language Processing.
...
if(i==1){
assign(paste0("Data"), read.table(txt_files[i],header = FALSE, sep = ","))
}
if(!i==1){
assign(paste0("Test",i), read.table(txt_files[i],header = FALSE, sep = ","))
